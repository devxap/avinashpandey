...
export const Experience = () => {
    const textItems = [
      ...
      const extendedContent = [
        "Led FED KIIT as President from Nov 2023 to Oct 2024. Key responsibilities included project management, team recruitment, and fostering organizational growth. Skills: Experience, Data Analysis, Marketing Management, Public Relations, Corporate Communications.",
